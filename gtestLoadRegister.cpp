...
TEST(testLoadRegister, CPUcyclesNeg)
{
...
TEST(testLoadRegister, LDA_IM_TEST_ZERO_FLAG)
{
...
TEST(testLoadRegister, LDA_INDY_TEST)
{
	ResetCpu(&gtestLoadcpu, &gtestLoadmem);
	gtestLoadcpu.y = 0x04;
...
TEST(testLoadRegister, LDA_INDY_BOUNDARY_TEST)
{
	ResetCpu(&gtestLoadcpu, &gtestLoadmem);
	gtestLoadcpu.y = 0xFF;
